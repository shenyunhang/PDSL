...
class OICROutputs(object):
    ...
    def softmax_cross_entropy_loss(self):
        ...
        Deprecated
        """
        _log_classification_stats(self.pred_class_logits, self.gt_classes, suffix=self.refine_k)
        loss = cross_entropy(
...
class OICROutputLayers(nn.Module):
    ...
    def losses(self, predictions, proposals):
        ...
        _log_classification_stats(scores, gt_classes, suffix="_r" + str(self.refine_k))
