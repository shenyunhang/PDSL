...
def build_wsl_resnet_v2_backbone(cfg, input_shape):
    """
...
@BACKBONE_REGISTRY.register()
def build_wsl_resnet_v2_fpn_backbone(cfg, input_shape: ShapeSpec):
    """
    Args:
    ...
    """
    bottom_up = build_wsl_resnet_v2_backbone(cfg, input_shape)
